                    ...
                    <div class="order-products">
                        @foreach ($order->products as $products)
                            <div class="order-products-item">
                                <div><img src="{{ asset($products->image) }}" alt="Product Image"></div>
                                <div>
                                    <div>
                                        <a href="{{ route('shop.show', $products->slug) }}">{{ $products->name }}</a>
                                    </div>
                                    <div>{{ presentPrice($products->price) }}</div>
                                    <div>Quantity: {{ $products->pivot->quantity }}</div>
                                </div>
                            </div>
                        @endforeach
