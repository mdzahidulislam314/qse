            ...
            <div class="row text-center">
                ...
                <div class="member col-xs-6 col-md-3">
                    <div class="inner">
                        ...
                        <div class="info">
                            <div class="name"><a href="#"> Michel Black </a></div>
                ...
                <div class="member col-xs-6 col-md-3">
                    <div class="inner">
                        ...
                        <div class="info">
                            <div class="name"><a href="#"> Juliana Moor </a></div>
                            <div class="regency">Volunteer</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="member col-xs-6 col-md-3">
                    <div class="inner">
                        ...
                        <div class="info">
                            <div class="name"><a href="#"> Andre Russel</a></div>
                            <div class="regency">Volunteer</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="member col-xs-6 col-md-3">
                    <div class="inner">
                        ...
                        <div class="info">
                            <div class="name"><a href="#"> Amily James</a></div>
                            <div class="regency">Volunteer</div>
                        </div>
                    </div>
                </div>
