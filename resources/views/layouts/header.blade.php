<div class="topbar">
    <div class="container">
        <div class="row">
            <div class="bar-phone"><i class="fa fa-phone"></i> <span>Call Us :</span> <strong>+1-310-341-3870</strong></div>
            <div class="bar-mail"><i class="fa fa-envelope"></i> <span>Mail Us :</span> <strong>info@charityhope.com</strong></div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand logo" href="index.html"><img src="front-end/images/logo.png" class="img-responsive" /></a>
            </div>
