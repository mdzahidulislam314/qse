        ...
        <div class="page-content contact-us">
            <div class="container">
                <section class="category-section category-2cols-simple mb-10 pb-1">
                    ...
                    <h2 class="title title-center mb-2">Flash Deal</h2>
                    <div class="bit-count-down title-center align-items-center d-flex mb-10" data-date="{{ date('Y/m/d H:i:s', $data->end_date) }}"></div>

                    <div class="product-wrapper row cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                        @foreach($data->flashdealProducts as $row)
                            @php
