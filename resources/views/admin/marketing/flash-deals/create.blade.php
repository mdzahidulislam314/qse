                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-block">
                                            <a href="{{route('flashdeals.index')}}" class="btn btn-primary btn-round waves-effect waves-light">
                                                <i class="fa fa-list"></i>List Flash Deals</a>
                                        </div>
                                    </div>
                                    <div class="card">
                                        <div class="card-block">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control sale-date" id="sale-date" name="start_date" />
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="title">End Date</label>
                                                                <input type="text" class="form-control sale-date" id="sale-date" name="end_date" />
                                                            </div>
                                    ...
                                    <div class="card sticky-save-btn">
                                        <div class="card-body">
                                            <div class="button-items text-right">
                                                ...
                                                <button type="submit" class="btn btn-info w-lg waves-effect waves-light">Save</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        $(document).ready(function(){
            ...
            $('#products').on('change', function(){
                ...
                if(product_ids.length > 0){
                    $.post('{{ route('flashdeal.products') }}', {_token:'{{ csrf_token() }}', product_ids:product_ids}, function(data){
