...
<head>
    ...
    <!-- waves.css -->
    <link rel="stylesheet" href="/admin/assets/pages/waves/css/waves.min.css" type="text/css" media="all"><!-- feather icon --> <link rel="stylesheet" type="text/css" href="/admin/assets/icon/feather/css/feather.css">
            ...
            <div class="col-sm-12">
                <form class="md-float-material form-material" action="{{ route('admin.login.post') }}" method="POST">
                    ...
                    <div class="text-center">
                        <img src="{{asset( $settingsArr['header_logo'] ?? '' )}}" alt="logo.png" width="180">
                    </div>
