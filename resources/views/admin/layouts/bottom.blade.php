...
<!-- Float Chart js -->
<script src="/admin/assets/pages/chart/float/jquery.flot.js"></script>
<script src="/admin/assets/pages/chart/float/jquery.flot.categories.js"></script>
<script src="/admin/assets/pages/chart/float/curvedLines.js"></script>
<script src="/admin/assets/pages/chart/float/jquery.flot.tooltip.min.js"></script>

<script type="text/javascript" src="/admin/bower_components/switchery/js/switchery.min.js"></script>
<!-- data-table js -->
...
<script src="/admin/assets/vendor/sweetalert2.min.js"></script>
<!-- Select 2 js -->
<script type="text/javascript" src="/admin/bower_components/select2/js/select2.full.min.js"></script>
<!-- Custom js -->
<script src="/admin/assets/js/pcoded.min.js"></script>
<script src="/admin/assets/js/classie.js"></script>
<script type="text/javascript" src="/admin/assets/js/modalEffects.js"></script>
<script type="text/javascript" src="/admin/assets/pages/advance-elements/custom-picker.js"></script>
<script type="text/javascript" src="/admin/assets/pages/advance-elements/select2-custom.js"></script>
<script src="/admin/assets/pages/data-table/js/data-table-custom.js"></script>
<script src="/admin/assets/js/vertical/vertical-layout.min.js"></script>
<script type="text/javascript" src="/admin/assets/pages/dashboard/crm-dashboard.min.js"></script>
<script type="text/javascript" src="/admin/assets/js/script.min.js"></script>
